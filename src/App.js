import {printStart, printResult, printError} from "./view/outputView.js";
...
import {validateCoachName} from "./utils/validateCoachName.js";
...
class App {
  async play() {
		...
		while (true) {
			try {
				coachName = await inputCoachName();
				coachNameArray = getCoachArray(coachName);
				validateCoachName(coachNameArray);
				break;
			} catch (e) {
